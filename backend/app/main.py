...
from .routers import (admin, ai, anomalies, attachments, auth as auth_router, case, case_set, cases, charts as charts_router, compute as compute_router, events, exclusions as exclusions_router, graph, iocs, jobs, library, mcp, parsers,
...
for r in (case, cases, attachments, sources, events, timeline, graph, case_set, iocs, jobs, library, report, settings, compute_router, ai, admin, parsers, rules, exclusions_router, anomalies, charts_router, mcp, auth_router):
